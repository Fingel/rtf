...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'rtf_protest', 'date', self.gf('django.db.models.fields.DateField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'Protest.date'
        db.alter_column(u'rtf_protest', 'date', self.gf('django.db.models.fields.DateField')())
