...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Protest.date'
        db.alter_column(u'rtf_protest', 'date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Protest.date'
        db.alter_column(u'rtf_protest', 'date', self.gf('django.db.models.fields.DateField')(auto_now=True, default=datetime.datetime(2013, 6, 17, 0, 0)))
